...
<script>
import MyCreditCardRecordListItem from "@/components/MyCreditCardRecordListItem.vue";
import NoneView from "@/components/NoneView.vue";
  ...
  methods: {
    ...
    loadMore: function() {
      ...
      this.GeneralGetData({
        ...
        reqData: { type: 23, page: this.page, limit: 10 },
